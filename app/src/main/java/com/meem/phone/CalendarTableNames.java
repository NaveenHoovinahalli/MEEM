 ...
 */
public class CalendarTableNames {
    ...
    public static final String CREATE_CAL_COLOR_TABLE = "CREATE TABLE " + CAL_COLOR_TABLE + "( " + "checksum  INTEGER, " + "alpha TEXT, " + "red TEXT, " + "green TEXT, " + "blue TEXT )";


    public static final String CREATE_REMINDERS_LIST_TABLE = "CREATE TABLE " + REMINDERS_LIST_TABLE + "( " + "checksum  INTEGER, " + "absolutedate TEXT, " + "reminder_minutes TEXT, " + "reminder_eventId TEXT, " + "reminder_method  TEXT )";


    public static final String CREATE_RRULE_TABLE = "CREATE TABLE " + RRULE_TABLE + "( " + "checksum  INTEGER, " + "interval TEXT, " + "frequency TEXT, " + "rrend TEXT, " + "occurence_count INTEGER )";

    public static final String CREATE_DAYSOFWEEK_TABLE = "CREATE TABLE " + DAYSOFWEEK_TABLE + "( " + "checksum  INTEGER, " + "daysofweek INTEGER, " + "week_num INTEGER )";
    public static final String CREATE_DAYSOFMONTH_TABLE = "CREATE TABLE " + DAYSOFMONTH_TABLE + "( " + "checksum  INTEGER, " + "daysofmonth INTEGER )";
    public static final String CREATE_DAYSOFYEAR_TABLE = "CREATE TABLE " + DAYSOFYEAR_TABLE + "( " + "checksum  INTEGER, " + "daysofyear INTEGER )";
    public static final String CREATE_WEEKOFYEAR_TABLE = "CREATE TABLE " + WEEKOFYEAR_TABLE + "( " + "checksum  INTEGER, " + "weekofyear INTEGER )";
    public static final String CREATE_MONTHSOFYEAR_TABLE = "CREATE TABLE " + MONTHSOFYEAR_TABLE + "( " + "checksum  INTEGER, " + "monthsofyear INTEGER )";
    public static final String CREATE_SETPOSITIONS_TABLE = "CREATE TABLE " + SETPOSITIONS_TABLE + "( " + "checksum  INTEGER, " + "setpositions INTEGER )";
    public static final String CREATE_LIST_OF_ATTENDEES_TABLE = "CREATE TABLE " + LIST_OF_ATTENDEES_TABLE + "( " + "checksum  INTEGER, " + "attendee_email TEXT, " + "attendee_identity TEXT, " + "attendee_idnamespace TEXT, " + "attendee_name TEXT, " + "attendee_relationship TEXT, " + "attendee_status TEXT, " + "attendee_type TEXT, " + "attendee_eventid TEXT )";

    public static final String CREATE_LIST_OF_INSTANCES_TABLE = "CREATE TABLE " + LIST_OF_INSTANCES_TABLE + "( " + "checksum  INTEGER, " + "instance_begin TEXT, " + "instance_end TEXT, " + "instance_end_day TEXT, " + "instance_end_minute TEXT, " + "instance_event_id TEXT, " + "instance_start_day TEXT, " + "instance_start_minute TEXT )";
