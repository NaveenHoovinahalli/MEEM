 ...
 */
public class MessagesTableName {
    ...
    public static final String CREATE_VAULT_MESSAGE_TABLE = "CREATE TABLE " + VAULT_MESSAGE_TABLE + "( " + "upid TEXT, " + "checksum INTEGER, " + "ismirr INTEGER )";
    public static final String CREATE_SMS_MSG_TABLE = "CREATE TABLE " + SMS_MSG_TABLE + "( " + "checksum  INTEGER, " + "identi2 TEXT, " + "address TEXT, " + "thread_id TEXT, " + "person TEXT, " + "date TEXT, " + "date_sent TEXT, " + "protocol TEXT, " + "read TEXT, " + "status TEXT, " + "reply_path_present TEXT, " + "subject TEXT, " + "body TEXT, " + "service_center TEXT, " + "locked TEXT, " + "error_code TEXT, " + "seen TEXT, " + "type TEXT, "
