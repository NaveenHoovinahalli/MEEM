...
public class MessagesCursorAdapter extends CursorAdapter {
    ...
    private MeemTextView mAddress;
    private MeemTextView mDesc;
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        return LayoutInflater.from(context).inflate(R.layout.messagedetaillistitem, parent, false);
    }
    ...
    public void bindView(View view, final Context context, final Cursor cursor) {
        ...
        mAddress = (MeemTextView) view.findViewById(R.id.address);
        mDesc = (MeemTextView) view.findViewById(R.id.desc);
        mAddress.setText(cursor.getString(1));
        mDesc.setText(cursor.getString(4));
