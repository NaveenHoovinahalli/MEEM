 ...
 */
public class HelpNWPagerAdapter extends Fragment implements View.OnClickListener {
    ...
    private void html0() {
        mWeb.loadUrl(BASE_URL + "what_is_meemnetwork.html");
    }

    private void html1() {
        mWeb.loadUrl(BASE_URL + "terminology.html");

    }

    private void html2() {
        mWeb.loadUrl(BASE_URL + "how_it_works.html");

    }

    private void html3() {
        mWeb.loadUrl(BASE_URL + "getting_started.html");

    }

    private void html4() {
        mWeb.loadUrl(BASE_URL + "using_meem_desktop_app.html");

    }

    private void html5() {
        mWeb.loadUrl(BASE_URL + "platform_supported.html");

    }

    private void html6() {
        mWeb.loadUrl(BASE_URL + "sms_and_copy.html");
    ...
    private void html11() {
        mWeb.loadUrl("file:///android_asset/html/" + "us_Visible.html");
