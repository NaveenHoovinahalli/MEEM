...
public class CircleView extends View {
    ...
    public CircleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            try {
                radius = a.getDimensionPixelSize(R.styleable.CircleView_cv___radius, DEFAULT_RADIUS);
                color = a.getInt(R.styleable.CircleView_cv___color, DEFAULT_COLOR);
                filled = a.getBoolean(R.styleable.CircleView_cv___filled, true);
            } finally {
                a.recycle();
            }
        }
