...
public class MusicCursorAdapter extends CursorAdapter {
    ...
    public MusicCursorAdapter(Context context, Cursor cursor) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        return LayoutInflater.from(context).inflate(R.layout.musicdetaillistitem, parent, false);
    }
    ...
    public void bindView(View view, final Context context, final Cursor cursor) {
        ...
        mSize.setText(convertKBtoMB(Long.parseLong(cursor.getString(5))) + "MB");
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkBox.isChecked()) {
                    if (hashMap.size() >= 256) {
                        Toast.makeText(context, "Hashmapsize <=3", Toast.LENGTH_SHORT).show();
                    ...
                    genDataInfo.fSize = mCursor.getString(5);
