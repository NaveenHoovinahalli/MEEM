 ...
 */
public class ContactItemDetailsV2 extends Fragment implements MainActivity.ToolBarItemClickListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (image_string != null && !image_string.equals(""))
            bob = str64TobyteArr(image_string);
    ...
    public void queryFromBD() {
        ...
        String query = "SELECT DISTINCT c.checksum as _id,c.displayname,p.number,e.email_id,p.type,c.photobitmap" +
                ...
                "                    where c.checksum in (select checksum from vault_contacts_table) and c.checksum=" + checksum;
    ...
    private void setValues() {
        ...
        // arun: 13feb2018: added to handle strange email ids (e.g. with single quote characters in between name part of email id)
        // see bug report id: 74783583. also note that email ids can very well be null.
        if(email != null) {
