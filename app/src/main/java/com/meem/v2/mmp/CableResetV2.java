...
public class CableResetV2 extends MMPV2CtrlMsg {
    public CableResetV2(ResponseCallback responseCallback) {
        super("CableRestV2", MMPV2Constants.MMP_CODE_DELETE, responseCallback);
    }
    ...
    protected boolean kickStart() {
        ...
        ByteBuffer msg = mmpv2.getCableResetMsg();
